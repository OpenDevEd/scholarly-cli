...
def parse_arguments():
    ...
    parser.add_argument('--patents', type=bool, default=False, help='NEEDS TO BE IMPLEMENTED.')
    parser.add_argument('--citations', type=bool, default=False, help='NEEDS TO BE IMPLEMENTED.')
    parser.add_argument('--year_low', type=int, default=None, help='NEEDS TO BE IMPLEMENTED.')
    parser.add_argument('--year_high', type=int, default=None, help='NEEDS TO BE IMPLEMENTED.')
    ...
    parser.add_argument('--save', type=str, help='Output file name without extension - otherwise the search query will be used')
...
def main():
    ...
    # This is not useful - retrieving all results to just count them isn't a good strategy.
    # if args.count:
    ...
    #     return
    # TODO: explore whether a results counter is natively supported. Otherwise amend scholarly to do so.

    # TODO: The scholarly.search_pubs needs to include the specifed args:
    ...
    # TODO: Need to check what happens if e.g. args.year_low is undefined.
    search_results = scholarly.search_pubs(search_query)
# TODO:
#
# https://scholarly.readthedocs.io/en/latest/scholarly_user.html
#
...
# start_index (int, optional) – starting index of list of publications, defaults to 0
    ...
    # TODO: You could implement a 'sort by num_citations', but that's different from 'relevance' provided by scholar, see comments above.
    #try:
    #    if args.sort_by == "citations":
    #        retrieved_results.sort(key=lambda x: x.get('num_citations', 0), reverse=(args.sort_order == 'desc'))
    # However, this would only work if the results are not chuked....
